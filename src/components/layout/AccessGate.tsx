...
import { Clock, MessagesSquare, Mail } from "lucide-react";
...
export function AccessGate({ children }: { children: ReactNode }) {
  ...
  // No cohort (authenticated but not in any cohort) - still allow access
  // They might be a demo user or just signed up
  if (accessStatus.reason === "no-cohort") {
    return <>{children}</>;
  }
